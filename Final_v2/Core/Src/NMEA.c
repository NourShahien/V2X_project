...
void Build_Msg(char *msg, double lat, double longt, char NS, char EW,
	...
	snprintf(lattiude,11, "%.6f", lat); // @suppress("Float formatting support")
	snprintf(longtiude,11, "%.6f", longt); // @suppress("Float formatting support")
	snprintf(direction_string,8, "%.3f", direction); // @suppress("Float formatting support")
